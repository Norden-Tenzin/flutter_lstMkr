...
class CalendarSelectedCell extends StatefulWidget {
  final DateTime date;
  const CalendarSelectedCell({
    Key? key,
    required this.date,
  }) : super(key: key);

  @override
  _CalendarSelectedCellState createState() => _CalendarSelectedCellState();
}

class _CalendarSelectedCellState extends State<CalendarSelectedCell> {
